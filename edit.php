...
<nav class="navbar navbar-expand-lg navbar-dark" id="navbar">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <center>
            <h1 style="margin-top:1em";>Updation Data into Database using PHP</h1>
        ...
        <form action="" method='post'>
            ...
            <input type='text' name='Mother_Name' placeholder='Mother Name'><br>
            <input type='text' name='Stu_Phone_Number' placeholder='Student PhNo'><br>
            <input type='text' name='Par_Phone_Number' placeholder='Parent PhNo'><br>
...
$query = "UPDATE student SET Name ='$_POST[Name]',Dob ='$_POST[Dob]',Year ='$_POST[Year]',Father_Name='$_POST[Father_Name]',Mother_Name='$_POST[Mother_Name]',Stu_Phone_Number='$_POST[Stu_Phone_Number]',Par_Phone_Number='$_POST[Par_Phone_Number]',Address='$_POST[Address]',Fees='$_POST[Fees]',Paid='$_POST[Paid]',Balance='$_POST[Balance]',Staff_Name='$_POST[Staff_Name]' WHERE Roll_No='$_POST[Roll_No]'";
