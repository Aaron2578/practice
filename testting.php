        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <form style="text-align:justify; margin-top: 3em;margin-bottom: 3em;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
              ...
              <input type="text" name="Parent_Phone_No" placeholder="Parent Phone No" required><br><br>
              <label>Address:</label><br><textarea rows="5" cols="33" name="Address" placeholder="Address"></textarea>
              &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<button class="btn btn-primary" type="submit" value="Submit">Submit</button>
            </form>
          </div>
    ...
    <footer style="background-color: black;padding-bottom: 10px;padding-top: 10px;text-align: center;">
      ...
      <script>
        ...
        var typed = new Typed(".auto-type", {
            strings:["Practice Coding","Gain Knowledge","Became An Developer"],
            typeSpeed:150,
            backSpeed: 150,
            loop: true
        })
