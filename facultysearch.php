...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="navbar">
      ...
      <!--Content-1-->
      <h4 style="text-align:center;margin-top:1em;color:black">Department Faculty <span class="auto-type" style="color:red;font-weight: bold;"></span></h4>
...
<div class="col-md-12" style="margin-bottom:2em;text-align:center;">
  <div class="card-mt-4">
    <div class="card-body">
        ...
        <tbody>
          <?php
            ...
            if(isset($_GET['search']))
            {
              ...
              $query = "SELECT * FROM faculty WHERE CONCAT(Staff_id,Staff_Name) LIKE '%$filtervalues%' ";
