...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="navbar">
      ...
      <!--Content-1-->
<h4 style="text-align:center;margin-top:3em;">Final Year <span class="auto-type" style="color:red;font-weight: bold;"></span></h4>
<div style="margin-top:6em;margin-bottom:7em;">
      <div class="card-body" style="text-align:center;">
    <div class="row">
    <div class="col-md-6"><a href="test1.php"><button class="btn button">Full data</button></a><br><br><blink style="color:red;">Fetch All Data</blink></div>
      <div class="col-md-6"><a href="search.php"><button class="btn button">Search</button></a><br><br><blink style="color:red;">Search Data</blink></div>
