...
<h4 style="text-align:center;margin-top:1em;">Final Year <span class="auto-type" style="color:red;font-weight: bold;"></span></h4>
    <div class="container-fluid">
        <div class="row mt-3">
            <div class="col">
                <div class="card mt-2">
           ...
           <?php
                while($row = mysqli_fetch_assoc($result))
                {
                    ...
                    ?>
                        ...
                        <td><?php echo $row['Par_Phone_Number']; ?></td>
                        <td><?php echo $row['Address']; ?></td>
                        <td><a href='edit.php' class="btn btn-primary">Edit</td>
                </tr>
                    <?php
                }
